...
export default function ServiciosContent() {
  ...
  useEffect(() => {
    if (categoria) {
      // Mapeo de IDs de áreas a IDs de secciones en el DOM
      const sectionMap: Record<string, string> = {
        electoral: "seccion-electoral",
        tecnologia: "seccion-tecnologia",
        encuestas: "seccion-encuestas",
        "asesoria-juridica": "seccion-comunicacion",
      };

      const sectionId = sectionMap[categoria];
      if (sectionId) {
  ...
  return (
    <>
      ...
      <section
        ...
        className="section-padding bg-tyse-light-gray/30"
      >
        <div className="container-tyse">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
      ...
      <section id="seccion-tecnologia" className="section-padding bg-white">
        <div className="container-tyse">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section id="seccion-comunicacion" className="section-padding bg-white">
        <div className="container-tyse">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
